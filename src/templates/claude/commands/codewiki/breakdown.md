...
- Update `index.md` with the new entries.
- Keep the index "Last updated" date and "Total pages" count current.
- Update `_backlinks.json` after the new pages and links exist.
- Append a concise `## [YYYY-MM-DD] breakdown | Subject` entry to `log.md`.

...
**Plans:** 3 plans
Plans:
- [x] 03-01-PLAN.md -- Create 6 skill source markdown files (ingest, query, lint, prd, tasks, process)
...
**Success Criteria** (what must be TRUE):
  1. `src/templates/skills/codewiki-absorb/SKILL.md` exists with instructions to extract knowledge from recent git changes, cross-reference wiki, propose updates with anti-cramming/anti-thinning rules
  2. `src/templates/skills/codewiki-breakdown/SKILL.md` exists with instructions to find referenced-but-undocumented entities, rank by backlink count, propose new pages
...
Plans:
- [x] 03.1-01-PLAN.md — Create absorb and breakdown skill sources
...
- [x] 04.1.2-03-PLAN.md — Update init reporting for combined skill installs and pending non-Claude integrations

...
const REQUIRED_TEMPLATE_FILES = [
  ...
  "dist/templates/hooks/pre-wiki-context.mjs",
  "dist/templates/hooks/post-verify.sh",
  "dist/templates/hooks/post-verify.mjs",
  "dist/templates/hooks/session-end.sh",
  "dist/templates/hooks/session-end.mjs",
  "dist/templates/hooks/codewiki-hook-lib.mjs",
  ...
  "dist/templates/codex/hooks/user-prompt-submit.mjs",
  "dist/templates/codex/hooks/pre-tool-use.sh",
  "dist/templates/codex/hooks/pre-tool-use.mjs",
  "dist/templates/codex/hooks/post-tool-use.sh",
  "dist/templates/codex/hooks/post-tool-use.mjs",
  "dist/templates/codex/hooks/stop.sh",
  "dist/templates/codex/hooks/stop.mjs",
  "dist/templates/codex/hooks/codewiki-wrapper-lib.mjs",
  ...
  "dist/templates/copilot/hooks/pre-tool-use.mjs",
  "dist/templates/copilot/hooks/post-tool-use.sh",
  "dist/templates/copilot/hooks/post-tool-use.mjs",
  "dist/templates/copilot/hooks/agent-stop.sh",
  "dist/templates/copilot/hooks/agent-stop.mjs",
  "dist/templates/copilot/hooks/session-end.mjs",
  "dist/templates/copilot/hooks/codewiki-wrapper-lib.mjs",
